...
mixin _$CategoryRecord {
 ...
 int? get id; int get categoryId; int get recordId; DateTime? get createdAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CategoryRecord&&(identical(other.id, id) || other.id == id)&&(identical(other.categoryId, categoryId) || other.categoryId == categoryId)&&(identical(other.recordId, recordId) || other.recordId == recordId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,categoryId,recordId,createdAt);

@override
String toString() {
  return 'CategoryRecord(id: $id, categoryId: $categoryId, recordId: $recordId, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 int? id, int categoryId, int recordId, DateTime? createdAt
});
...
/// Create a copy of CategoryRecord
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? categoryId = null,Object? recordId = null,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  int categoryId,  int recordId,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CategoryRecord() when $default != null:
return $default(_that.id,_that.categoryId,_that.recordId,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  int categoryId,  int recordId,  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _CategoryRecord():
return $default(_that.id,_that.categoryId,_that.recordId,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  int categoryId,  int recordId,  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _CategoryRecord() when $default != null:
return $default(_that.id,_that.categoryId,_that.recordId,_that.createdAt);case _:
  return null;
...
class _CategoryRecord implements CategoryRecord {
  const _CategoryRecord({this.id, required this.categoryId, required this.recordId, this.createdAt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CategoryRecord&&(identical(other.id, id) || other.id == id)&&(identical(other.categoryId, categoryId) || other.categoryId == categoryId)&&(identical(other.recordId, recordId) || other.recordId == recordId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}
...
/// Create a copy of CategoryRecord
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? categoryId = null,Object? recordId = null,Object? createdAt = freezed,}) {
