...
class CommonCard extends StatelessWidget {
  ...
  BorderSide getBorderSide(BuildContext context, Set<WidgetState> states) {
    ...
    return BorderSide(color: isSelected ? colorScheme.primary : colorScheme.onSurface.withOpacity(0.12));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return OutlinedButton(
      ...
      style: ButtonStyle(
        ...
        backgroundColor: WidgetStateProperty.resolveWith((states) => getBackgroundColor(context, states)),
        side: WidgetStateProperty.resolveWith((states) => getBorderSide(context, states)),
      ),
      onPressed: onPressed,
      child: Builder(
        builder: (_) {
